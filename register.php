...
<br><br>
        <label for="repeatemail">Repeat E-mail</label><br>
        <input required id="repeatemail" type="text" name="repeatemail" placeholder="Repeat E-mail..">
<br><br>
        <label for="password">Password</label><br>
        <input required id="password" type="password" name="password" placeholder="Your Password..">
<br><br>
        <label for="repeatpassword">Repeat Password</label><br>
        <input required id="repeatpassword" type="password" name="repeatpassword" placeholder="Repeat Password..">
<br><br>
